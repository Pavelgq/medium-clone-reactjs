...
const Articles = (props) => {
    ...
    const isAuthor = () => {
        console.log(currentUserState.isLoggedIn, fetchArticleResponse)
                    ...
                    <div className='container'>
                        ...
                        <div className='article__meta'>
                            <Link to={`/profiles/${fetchArticleResponse.article.author.username}`}>
                                <img className='avatar__img' src={fetchArticleResponse.article.author.image} alt='avatar'/>
                            </Link>
                            <span className='article__date'>{fetchArticleResponse.article.createdAt}</span>
                        </div>
                        {isAuthor() && (
                            <span>
                                <Link className='button' to={`/articles/${fetchArticleResponse.article.slug}/edit`}>Edit</Link>
                                <button className='' onClick={deleteArticle}>Delete</button>
                            </span>
                        )}
                    </div>
                )}
