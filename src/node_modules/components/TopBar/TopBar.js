        ...
        <nav className="nav">
            <div className="container">
                ...
                <ul className="nav__list list">
                    ...
                    {currentUserState.isLoginedIn === false && (
                        <Fragment>
                            <li className="list__item item">
                    ...
                    {currentUserState.isLoginedIn && (
                        <Fragment>
                            <li className="list__item item">
                                <NavLink to='/articles/new' className='item__link'>
                                ...
                                <NavLink 
                                    ...
                                    <div className='item__avatar avatar'>
                                         <img 
                                            ...
                                            src={currentUserState.currentUser.image || 'https://static.productionready.io/images/smiley-cyrus.jpg'} 
                                            alt='user avatar'
                                        />
                                    </div>
